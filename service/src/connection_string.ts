...
import { ConnectionString } from '@azure-iot/azure-iot-common';
 ...
 *
 * @throws {@azure-iot/azure-iot-common.ArgumentError} if the string is missing one of the required attributes.
 */
export function parse(source: string): ConnectionString {
  /*Codes_SRS_NODE_IOTHUB_CONNSTR_05_001: [The parse method shall return the result of calling @azure-iot/azure-iot-common.ConnectionString.parse.]*/
